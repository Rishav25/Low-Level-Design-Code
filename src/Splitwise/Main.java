...
public class Main {
    public static void main(String[] args) {
        ...
        swService.createExpense(new ExpenseBuilder().setDescription("Expense 1").setPaidBy(p1)
                .setPeopleInvolved(List.of(p1, p2)).setTotalAmount(8000).setSplitStrategy(new SplitEqualPayStrategy()));
        ...
        swService.addGroupExpense(g1, new ExpenseBuilder().setDescription("Expense 4").setPaidBy(p3)
                ...
                .setSplitStrategy(new SplitPercentageStrategy()).setSplitValues(List.of(40.0, 40.0, 0.0, 20.0)));

        swService.addGroupExpense(g1, new ExpenseBuilder().setDescription("Expense 5").setPaidBy(p1)
                .setPeopleInvolved(List.of(p1, p2, p3, p4)).setTotalAmount(100000)
        ...
        System.out.println(p1.getBalanceSheet());
        System.out.println(p2.getBalanceSheet());
        System.out.println(p3.getBalanceSheet());
    }
}
